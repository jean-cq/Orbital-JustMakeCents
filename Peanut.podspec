...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Jingyi" => "jingyi0830@gmail.com" }
  # Or just: spec.author    = "Jingyi"
  # spec.authors            = { "Jingyi" => "jingyi0830@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Jingyi"
